...
export const JDITA = '{"nodeName": "document","children": [{"nodeName": "topic","attributes": {"id": "intro-product"},"children": [{"nodeName": "title","attributes": {},"children": [{"nodeName": "text","content": "Overview"}]}]}]}'
